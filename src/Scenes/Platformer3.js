class Platformer3 extends Phaser.Scene {
    ...
    // Bee
    this.my.sprite.clvl3 = this.add.sprite(this.beeX+85, this.beeY-50, "Commentlvl3");
        this.my.sprite.clvl3.scale = 0.19;
        this.my.sprite.clvl3.alpha = 0.8;
        this.my.sprite.clvl3.visible = false;
    ...
    if (this.my.beeClickState === 0 || this.my.beeClickState === 2) {
        this.my.sprite.clvl3.visible = true;
