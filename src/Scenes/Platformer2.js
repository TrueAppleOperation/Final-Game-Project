class Platformer2 extends Phaser.Scene {
    ...
    create() {
        console.log("Platformer2 scene created");
        ...
        // Player setup
        this.my.sprite.player = this.physics.add.sprite(0, 200, "iceCream", "tile_0107.png");
    ...
    // Bee
    this.my.sprite.lvl2c1 = this.add.sprite(this.beeX+85, this.beeY-50, "Comment1lvl2");
        this.my.sprite.lvl2c1.scale = 0.19;
        this.my.sprite.lvl2c1.alpha = 0.8;
        this.my.sprite.lvl2c1.visible = false;
    this.my.sprite.lvl2c2 = this.add.sprite(this.beeX+85, this.beeY-50, "Comment2lvl2");
        this.my.sprite.lvl2c2.scale = 0.19;
        this.my.sprite.lvl2c2.alpha = 0.8;
        this.my.sprite.lvl2c2.visible = false;
    ...
    if (this.my.beeClickState === undefined) {
        this.my.beeClickState = 0;
    }
    
    this.my.beeClickState = (this.my.beeClickState + 1) % 3;
    
    switch(this.my.beeClickState) {
        case 0: 
            this.my.sprite.lvl2c1.visible = false;
            this.my.sprite.lvl2c2.visible = false;
            break;
        case 1: 
            this.my.sprite.lvl2c1.visible = true;
            this.my.sprite.lvl2c2.visible = false;
            break;
        case 2:
            this.my.sprite.lvl2c1.visible = false;
            this.my.sprite.lvl2c2.visible = true;
            break;
    }
    });
