class Platformer4 extends Phaser.Scene {
    ...
    create() {
        ...
        this.groundLayer = this.map.createLayer("Ground-n-Platforms", this.tileset, 0, 90);
        this.groundLayer.setCollisionByProperty({ collides: true });

        this.my.sprite.dark = this.add.sprite(this.backgroundX, this.backgroundY, "DarkBackdrop");
        this.my.sprite.dark.scale = 100;
        this.my.sprite.dark.visible = false;

        // Player setup
        this.my.sprite.player = this.physics.add.sprite(0, 0, "iceCream", "tile_0107.png");
        ...
        // Candy
        this.candys = this.map.createFromObjects("RedCandy", {
        name: "candy",
        key: "tilemap_sheet",
        frame: 8
        });
        ...
        this.physics.world.enable(this.candys, Phaser.Physics.Arcade.DYNAMIC_BODY);
        this.candyGroup = this.add.group(this.candys);
        ...
        this.physics.add.collider(this.my.sprite.player, this.candyGroup, (player, candy) => {
        this.time.delayedCall(1500, () => {
            candy.body.setImmovable(false);
        ...
        // Tricker
        this.coins = this.map.createFromObjects("Tricker", {
            name: "trick",
            key: "tilemap_sheet",
            frame: 25
        });
        ...
        this.physics.add.collider(this.my.sprite.player, this.coneGroup, (player, cone) => {
            this.my.sprite.EndMessage.visible = true;
            this.my.sprite.MenuButton.visible = true;
            this.my.sprite.dark.visible = true;
        ...
        this.my.sprite.dark.scale = 100;
        this.my.sprite.dark.visible = false;
        this.my.sprite.EndMessage = this.add.sprite(this.centerX, this.centerY, "GAMEcompleted");
        this.my.sprite.EndMessage.scale = 0.2;
        this.my.sprite.EndMessage.visible = false;
        this.my.sprite.MenuButton = this.add.sprite(this.centerX+10, this.centerY+85, "MainMenuButton");
        this.my.sprite.MenuButton.scale = 0.05;
        this.my.sprite.MenuButton.visible = false;

        // Menu Button
        this.my.sprite.MenuButton.setInteractive({ useHandCursor: true });

        this.my.sprite.MenuButton.on('pointerover', () => {
        this.my.sprite.MenuButton.setScale(0.07);
        });

        this.my.sprite.MenuButton.on('pointerout', () => {
        this.my.sprite.MenuButton.setScale(0.05); 
        });

        this.my.sprite.MenuButton.on('pointerdown', () => {
        this.my.sprite.MenuButton.setScale(0.03);
            const sound = this.sound.add('switch_002');
            sound.play();
    });
        this.my.sprite.MenuButton.on('pointerup', () => {
        this.my.sprite.MenuButton.setScale(0.05);
        this.scene.start("mainMenu"); 
    });

    // Bee
    this.my.sprite.clvl4 = this.add.sprite(this.beeX+85, this.beeY-50, "Commentlvl4");
        this.my.sprite.clvl4.scale = 0.19;
        this.my.sprite.clvl4.alpha = 0.8;
        this.my.sprite.clvl4.visible = false;

    this.my.sprite.Bee = this.add.sprite(this.beeX, this.beeY, "bee");
        this.my.sprite.Bee.setScale(2);
        this.my.sprite.Bee.flipX = true;

    // Make the bee interactive
    ...
    if (this.my.beeClickState === 0 || this.my.beeClickState === 2) {
        this.my.sprite.clvl4.visible = true;
